      ...
      <main className="contact-page">
        ...
        <section className="contact-hero">
          <Reveal>
            ...
            <h1 className="contact-heading">Get Involved!</h1>
          </Reveal>
        </section>
        ...
        <div className="contact-grid">
          ...
          <Reveal className="contact-form-col">
            ...
            >
              ...
              <div className="form-group">
                <label htmlFor="message">How can we help you get more involved with our church? *</label>
          ...
          {/* Info column */}
          <Reveal delay={0.2} className="contact-info-col">
            <div className="contact-info-card">
              <h3 className="contact-info-title">Find out more ways to help!</h3>
              <p className="contact-info-text">
                There are so many ways to support our mission. Contact us to find out more about
                volunteer opportunities, fundraising events, and ways to get our message to your
                friends and family.
              </p>
              ...
              <div className="contact-socials">
                ...
                <div className="contact-social-icons">
                  ...
                  <a href="https://www.instagram.com/TTCUKOnline" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  ...
                  <a href="https://www.x.com/TTCUKOnline" target="_blank" rel="noopener noreferrer" aria-label="X">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                  </a>
                  <a href="https://www.youtube.com/@TTCUKOnline" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
